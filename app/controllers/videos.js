...
export default Ember.Controller.extend({
  ...
  watchedVideoCount: function() {
    return this.get('model.watchedVideos.length');
  }.property('model.watchedVideos.[]'),

  currentVideo: function() {
    var secondToLastIndex = this.get('watchedVideoCount') - 2;
    return this.get('model.watchedVideos').objectAt(secondToLastIndex);
  }.property('model.watchedVideos.[]'),
